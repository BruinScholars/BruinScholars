                    ...
                    <!-- Table -->
                        <table class="table">
                            ...
                            @foreach($users as $user)
                                <tr>
                                	<td> <span id="200300400" onclick="openMsg('<?php echo \Illuminate\Support\Facades\Auth::user()->name;?>', '<?php echo \Illuminate\Support\Facades\Auth::user()->id;?>', '<?php echo $user['user_name'];?>', '<?php echo $user['user_id'];?>')" > {{$user['user_name']}}</span>
