                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/create') }}">
                            ...
                            <div class="form-group{{ $errors->has('catagory') ? ' has-error' : '' }}">
                                <label for="catagory" class="col-md-4 control-label">Society</label>

                                <div class="col-md-6">
                                    <input id="catagory" type="text" class="form-control" name="catagory" value="{{ old('catagory') }}" required autofocus>
